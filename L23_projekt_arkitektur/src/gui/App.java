...
public class App {
    ...
    public static void initStorage() {
        ...
        Controller.createForestilling("Chess", LocalDate.of(2023, 8, 10), LocalDate.of(2023, 8, 20));
    ...
    public static void testPrint() {
        for (int i = 0; i < Storage.getKunder().size(); i++) {
            System.out.println("Navn: "+ Storage.getKunder().get(i).getName() + " Mobil: " + Storage.getKunder().get(i).getMobil());
