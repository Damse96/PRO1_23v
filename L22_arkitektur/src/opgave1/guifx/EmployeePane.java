...
public class EmployeePane extends GridPane {
	private TextField txfName, txfWage, txfemploymentYear,txfCompany, txfSalary;
	...
	public EmployeePane() {
		...
		Label lblYearofEmployment = new Label("Year of employment: ");
		this.add(lblYearofEmployment,1,5);
	...
	public void updateControls() {
		...
		if (employee != null) {
			...
			txfemploymentYear.setText("Årstal " + employee.getEmploymentYear());
