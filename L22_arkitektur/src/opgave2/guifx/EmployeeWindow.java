...
public class EmployeeWindow extends Stage {
    ...
    private void initContent(GridPane pane) {
        ...
        Label lblYearofEmployment = new Label("Yoe");
        pane.add(lblYearofEmployment,0,5);
        txfEmploymentYear = new TextField();
        pane.add(txfEmploymentYear, 0, 4);
    ...
    private void okAction() {
        ...
        if (name.length() == 0) {
            ...
            if (wage < 0) {
                ...
                int yearOfEmployment = Integer.parseInt(txfEmploymentYear.getText().trim());
                if (yearOfEmployment < 2000) {
                    lblError.setText("firmaet findes ikke");
                } else {
                    ...
                    if (employee != null) {
                        Controller.updateEmployee(employee, name, wage, yearOfEmployment);
                        ...
                        if (companyIsSelected) {
                            Controller.createEmployee(name, wage, yearOfEmployment, newCompany);
                        } else {
                            Controller.createEmployee(name, wage, yearOfEmployment);
                        }
                    }
                    hide();
                }
