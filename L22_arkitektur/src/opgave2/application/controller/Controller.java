...
public class Controller {
    ...
    public static Customer createCustomer(String navn, Company newCompany){
    ...
    public static void updateCustomer(Customer customer, String navn) {
        customer.setNavn(navn);
    }
